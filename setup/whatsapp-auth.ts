...
<html><head><title>NonnaClaw - WhatsApp Auth</title>
...
<script>
  var startKey = 'nonnaclaw_qr_start';
...
<html><head><title>NonnaClaw - Connected!</title>
<style>
...
<script>localStorage.removeItem('nonnaclaw_qr_start');</script>
</body></html>`;
